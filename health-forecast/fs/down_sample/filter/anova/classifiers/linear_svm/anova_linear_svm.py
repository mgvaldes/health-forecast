...
for i in range(0, num_experiments):
    ...
    raw_train_data = np.genfromtxt(
        '/home/mgvaldes/devel/MIRI/master-thesis/health-forecast/fs/raw/experiment_' + str(i) + '_down_sample_train.csv',
        delimiter=',')
    ...
    raw_test_data = np.genfromtxt(
        '/home/mgvaldes/devel/MIRI/master-thesis/health-forecast/fs/raw/experiment_' + str(i) + '_down_sample_test.csv',
        delimiter=',')
