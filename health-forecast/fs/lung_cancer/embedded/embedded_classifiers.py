...
def general_performance(main_path, dataset_type, sampling, sampling_timing, fs_step_name, classifier_step_name, chromosome):
    ...
    if fs_step_name == "rlr_l1":
        ...
        rlr_l1 = LogisticRegression(random_state=123456, class_weight="balanced", penalty='l1', dual=False, n_jobs=8)
    ...
    performance_metrics(experiment_results, pipe_gridsearch.best_estimator_, fs_step_name, classifier_step_name, X_train,
                        y_train, X_test, y_test, dataset_type, variable_names, sampling, sampling_timing, chromosome)
                ...
                for sampling in sampling_types:
                    ...
                    for dataset_type in dataset_types:
                        ...
                        for i in range(1, 23):
                            ...
                            chromosome_dir = dataset_dir + '/' + chromosome
