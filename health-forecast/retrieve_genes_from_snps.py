...
relevant_snps = np.genfromtxt(os.getcwd() + '/fs/' + disease + '/' + chromosome + '/' + fs_type[0] + '/' +
                              ...
                              sampling_type + '/' + dataset_type + '/genomic_epidemiological_best_model_stability_greater_than_35_features.csv', delimiter=',', dtype='S120')
...
with open(os.getcwd() + '/fs/' + disease + '/' + chromosome + '/' + fs_type[0] + '/' + fs_type[1] + '/classifiers/' +
          classifier_type + '/' + sampling_timing + '/' + sampling_type + '/' + dataset_type +
          '/genomic_epidemiological_top_snps_genes.csv', 'w') as f:
    w = csv.writer(f)
